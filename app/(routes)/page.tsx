          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            ...
            <div className="space-y-5 animate-slide-in-left">
              ...
              <p className="text-muted-foreground md:text-lg">
                We use modern technologies (Svelte, Next.js, Tailwind CSS, Node) για να
                φτιάχνουμε γρήγορα, ασφαλή και όμορφα προϊόντα. «Modern technologies» =
                σύγχρονα εργαλεία/τεχνολογίες.
              </p>
